  ...
  const StatCard = ({ title, value, icon }) => (
    <div className="bg-white rounded-lg shadow-md p-6">
      <div className="flex items-center justify-between">
        ...
        <div className="p-3 bg-accent bg-opacity-10 rounded-full">{icon}</div>
      </div>
    </div>
  )
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              <div className="bg-white rounded-lg shadow-md p-6">
                <h2 className="text-lg font-semibold mb-4">
                  {t("admin.dashboard.inquiryStats")}
                </h2>
                <div className="space-y-4">
                  <div>
                    <div className="flex justify-between mb-1">
                      <span className="text-sm font-medium text-gray-700">
                        {t("admin.dashboard.totalInquiries")}
                      </span>
                      <span className="text-sm font-medium text-gray-700">
              ...
              <div className="bg-white rounded-lg shadow-md p-6">
                ...
                <div className="space-y-3">
                  <a
                    ...
                    className="flex items-center p-3 bg-gray-50 hover:bg-gray-100 rounded-md transition duration-150"
                  >
                    <svg
              ...
              <div className="bg-white rounded-lg shadow-md p-6">
                ...
                <div className="space-y-4">
                  ...
                  {[
                    {
                      action: t("admin.dashboard.newDonation"),
                      time: "10 minutes ago",
                      amount: "₹5,000"
                    },
                    {
                      action: t("admin.dashboard.eventRegistration"),
                      time: "1 hour ago",
                      event: "Annual Charity Run"
                    },
                    {
                      action: t("admin.dashboard.inquiryResolved"),
                      time: "3 hours ago",
                      id: "INQ2345"
                    },
                    {
                      action: t("admin.dashboard.mediaUploaded"),
                      time: "5 hours ago",
                      count: 5
                    }
                  ].map((activity, index) => (
