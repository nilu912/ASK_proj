  ...
  return (
    <>
      ...
      <div className="container mx-auto px-4 py-12">
        <h1 className="text-3xl font-bold mb-8 text-center">{t('gallery.title')}</h1>
        ...
        <div className="flex flex-wrap justify-center mb-8">
          {categories.map(category => (
            <button
              ...
              className={`px-4 py-2 m-1 rounded-md ${activeCategory === category.id ? 'bg-accent text-white' : 'bg-gray-100 hover:bg-gray-200'}`}
            >
              {category.name}
            </button>
          ))}
